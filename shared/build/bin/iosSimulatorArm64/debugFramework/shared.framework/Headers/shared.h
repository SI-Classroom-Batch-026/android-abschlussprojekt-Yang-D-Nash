...
@class SharedBeanDefinition<T>, SharedCallbacks<T>, SharedCoreResolver, SharedExtensionManager, SharedFactoryInstanceFactory<T>, SharedHistoryRepository, SharedInstanceFactory<T>, SharedInstanceFactoryCompanion, SharedInstanceRegistry, SharedKind, SharedKoin, SharedKoinApplication, SharedKoinApplicationCompanion, SharedKoinConfiguration, SharedKoinDefinition<R>, SharedKoinOption, SharedKoinPlatform, SharedKoinPlatformTools, SharedKotlinArray<T>, SharedKotlinEnum<E>, SharedKotlinEnumCompanion, SharedKotlinException, SharedKotlinIllegalStateException, SharedKotlinLazyThreadSafetyMode, SharedKotlinNothing, SharedKotlinPair<__covariant A, __covariant B>, SharedKotlinRuntimeException, SharedKotlinThrowable, SharedKotlinUnit, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule, SharedLevel, SharedLifecycle_viewmodelViewModel, SharedLockable, SharedLogger, SharedModule, SharedOptionRegistry, SharedParametersHolder, SharedPropertyRegistry, SharedResolutionContext, SharedScope, SharedScopeDSL, SharedScopeRegistry, SharedScopeRegistryCompanion, SharedScopedInstanceFactory<T>, SharedSettingsRepository, SharedSingleInstanceFactory<T>, SharedStringQualifier, SharedTextHistory, SharedTextHistoryCompanion, SharedTypeQualifier, SharedUserRepository, UIViewController;

@protocol SharedCameraManager, SharedIHistoryDataSource, SharedKoinComponent, SharedKoinContext, SharedKoinExtension, SharedKoinScopeComponent, SharedKotlinAnnotation, SharedKotlinAutoCloseable, SharedKotlinComparable, SharedKotlinCoroutineContext, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinIterator, SharedKotlinKAnnotatedElement, SharedKotlinKClass, SharedKotlinKClassifier, SharedKotlinKDeclarationContainer, SharedKotlinLazy, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedMultiplatform_settingsSettings, SharedQualifier, SharedResolutionExtension, SharedScopeCallback;
...
__attribute__((swift_name("HistoryRepository")))
@interface SharedHistoryRepository : SharedBase
- (instancetype)initWithDataSource:(id<SharedIHistoryDataSource>)dataSource __attribute__((swift_name("init(dataSource:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)clearHistoryWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("clearHistory(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)deleteEntryByIdId:(int64_t)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteEntryById(id:completionHandler:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getAllHistory __attribute__((swift_name("getAllHistory()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveEntryEntry:(SharedTextHistory *)entry completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveEntry(entry:completionHandler:)")));
@end
...
__attribute__((swift_name("IHistoryDataSource")))
@protocol SharedIHistoryDataSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveEntryHistory:(SharedTextHistory *)history completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveEntry(history:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TextHistory")))
@interface SharedTextHistory : SharedBase
- (instancetype)initWithId:(SharedLong * _Nullable)id sourceText:(NSString *)sourceText translatedText:(NSString *)translatedText timestamp:(int64_t)timestamp __attribute__((swift_name("init(id:sourceText:translatedText:timestamp:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedTextHistoryCompanion *companion __attribute__((swift_name("companion")));
- (SharedTextHistory *)doCopyId:(SharedLong * _Nullable)id sourceText:(NSString *)sourceText translatedText:(NSString *)translatedText timestamp:(int64_t)timestamp __attribute__((swift_name("doCopy(id:sourceText:translatedText:timestamp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedLong * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSString *sourceText __attribute__((swift_name("sourceText")));
@property (readonly) int64_t timestamp __attribute__((swift_name("timestamp")));
@property (readonly) NSString *translatedText __attribute__((swift_name("translatedText")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TextHistory.Companion")))
@interface SharedTextHistoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedTextHistoryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetHistoryUseCase")))
@interface SharedGetHistoryUseCase : SharedBase
- (instancetype)initWithRepository:(SharedHistoryRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)invoke __attribute__((swift_name("invoke()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ManageHistoryUseCase")))
@interface SharedManageHistoryUseCase : SharedBase
- (instancetype)initWithRepository:(SharedHistoryRepository *)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveEntry:(SharedTextHistory *)entry completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("save(entry:completionHandler:)")));
@end
...
@property (class, readonly) SharedModule *sharedModule __attribute__((swift_name("sharedModule")));
@end
